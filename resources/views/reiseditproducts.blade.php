                        ...
                        <tr>
                            ...
                            <td style="width:13%;">
                                <input style="width:90%;" type="text" disabled
                                   {{--name="quantity_in_stock_{{$product->id}}"--}} placeholder="{{$product->quantity_in_stock == 0 ? 'Anbarda Yoxdur': $product->quantity_in_stock }}" >
                            </td>
{{--                            <td style="width:10%;">--}}
{{--                                <input type="checkbox" name="instock_{{$product->id}}"> Anbarda yoxdur</td>--}}
                            ...
                            <td style="width:8%;" class="position-relative">
                                ...
                                <select id="select" name="Decision_{{$product->id}}" required>
                                    <option {{ $product->Decision == 'Təhvil verilsin'?'selected' : '' }} value="Təhvil verilsin">Təhvil verilsin</option>
                                    <option {{ $product->Decision == 'Təmin olunsun'?'selected' : '' }} value="Təmin olunsun">Təmin olunsun</option>
                                    <option {{ $product->Decision == 'Qəbul olunmadı'?'selected' : '' }} value="Qəbul olunmadı">Qəbul olunmadı</option>
                                </select>
                            </td>
                        </tr>
                    @endforeach
